...
public class DatabaseInitializer {
    ...
    public void init() {
        ...
        createStudentIfNotExists("STU001", "John", "Doe", "123 Student Lane", 
                                new Date(), "997654321V", "0771234567");
        createStudentIfNotExists("STU002", "Jane", "Smith", "456 College Road", 
                                new Date(), "986543219V", "0772345678");
        createStudentIfNotExists("STU003", "Robert", "Johnson", "789 University Ave", 
                                new Date(), "975432198V", "0773456789");

        // Create some initial classes
        createClassIfNotExists("CLS001", "Web Development", 
                              "HTML, CSS, JavaScript fundamentals", 
                              "Mon, Wed 10:00-12:00");
        createClassIfNotExists("CLS002", "Java Programming", 
                              "Core Java and object-oriented principles", 
                              "Tue, Thu 14:00-16:00");        createClassIfNotExists("CLS003", "Database Design", 
                              "SQL and database principles", 
                              "Fri 09:00-13:00");
        createClassIfNotExists("CLS004", "Mobile App Development", 
                              "Android and iOS development", 
                              "Mon, Wed 14:00-16:00");
    }
      private void createStudentIfNotExists(String id, String firstName, String lastName, 
                                        String address, Date dob, String nic, String contact) {
